...
def make_model(absl_flags) -> hk.MultiTransformedWithState:
    ...
    def f():
        ...
        embed_model = {
            ...
            'cnn_lite': embed.CNNLiteEmbed, 'cnn_intermediate': embed.CNNIntermediateEmbed
        ...
        transition_model = {
            ...
            'cnn_lite': transition.CNNLiteTransition, 'cnn_intermediate': transition.CNNIntermediateTransition
